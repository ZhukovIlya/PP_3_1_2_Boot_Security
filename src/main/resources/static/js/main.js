...
const userFetch = {
    ...
    findUserByUser: async () => await fetch(`api/user`),
    findOneUser: async (id) => await fetch(`api/users/${id}`),
    addNewUser: async (user) => await fetch('api/users', {method: 'POST', headers: userFetch.head, body: JSON.stringify(user)}),
    updateUser: async (user, id) => await fetch(`api/user-update/${id}`, {method: 'POST', headers: userFetch.head, body: JSON.stringify(user)}),
...
async function infoUser() {
    ...
    await userFetch.findUserByUser()
        .then(res => res.json())
        .then(user => {
            temp += `
